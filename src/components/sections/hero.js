...
const Hero = () => {
  ...
  const two = <h2 className="big-heading">Vyshnavi.</h2>;
  const three = <h3 className="big-heading"> Curiosity fuels my technical exploration.</h3>;
  const four = (
    <>
      <p>
  ...
  const five = (
    <a
      ...
      href="mailto:ksvd1234@gmail.com"
      target="_blank"
      rel="noreferrer">
      Get In Touch!
    </a>
